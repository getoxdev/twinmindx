...
class SummaryServiceImpl @Inject constructor(
    ...
    companion object {
        private const val TAG = "SummaryServiceImpl"
    ...
    override fun streamSummary(transcript: String): Flow<String> = flow {
    ...
    override fun parseSummaryResult(rawJson: String): SummaryResult {
